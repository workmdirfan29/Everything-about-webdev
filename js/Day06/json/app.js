...
const person = {
    ...
    isSubscribed: true,
    hobbies: ["Running","Fightting","Shooting"],
    address: {
      city: "London",
      zipCode: "Continantal",
    },
  ...
  /* Output:
    {
      ...
      "isSubscribed":true,
      "hobbies":["Running","Fightting","Shooting"],
      "address":{"city":"London","zipCode":"Continantal"}
    }
  */
  ...
  console.log(parsedObject.name); // Output: "John Wick"
  console.log(parsedObject.hobbies); // Output: [London","zipCode":"Continantal"]
  // -----------------------